  <!-- Footer -->
 <footer  style="background-color: #000000;margin-top: 20px; color: white">
<div class="bg-dark">
  <div class="container">
    <!-- Grid row-->
...
<div class="container text-center text-md-left mt-5">
  ...
  <div class="row mt-3">
    ...
    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
      <!-- Content -->
      <h6 class="text-uppercase font-weight-bold">school</h6>
      <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;background-color: #6351ce;">
      <p>soyer le bienvenue dans notre application web pour la gestion des apprenant</p>
    </div>
    <!-- Grid column -->
    <!-- Grid column -->
    ...
    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
      ...
      <p>
        <i class="fas fa-envelope mr-3"></i> school@appweb.com</p>
      <p>
